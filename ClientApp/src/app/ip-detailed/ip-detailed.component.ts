...
@Component({
  selector: 'app-ip-detailed',
  templateUrl: './ip-detailed.component.html',
  styleUrls: ['./ip-detailed.component.css'],
  providers: [IpService]
})
export class IpDetailedComponent implements OnInit {
  ...
  getData(){
      this.ipservice.getIpInfo().subscribe(ipData => {
        this.data = ipData;
